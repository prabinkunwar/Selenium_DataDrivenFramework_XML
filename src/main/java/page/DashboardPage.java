...
public class DashboardPage {
	...
	@FindBy(how =How.XPATH, using = "//h2[contains(text(), 'Contacts')]") WebElement LIST_CUSTOMER_CONTACTS_HEADER_ELEMENT;
	...
	public void verifyListCustomerContactsPage() {
		Assert.assertEquals(LIST_CUSTOMER_CONTACTS_HEADER_ELEMENT.getText(), "Contacts", "Wrong Page !!");
	}
